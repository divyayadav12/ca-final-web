...
def fix():
    ...
    code = code.replace(
        ...
        'className="px-1 sm:px-2 py-2 sm:py-4 text-center text-[9px] md:text-sm font-bold text-[#1a2b4b] leading-tight whitespace-nowrap w-16'
    )
    
    code = code.replace(
        'className="mt-16 sm:mt-24 w-full max-w-sm mx-auto"',
        'className="mt-2 sm:mt-24 w-full max-w-sm mx-auto z-10 relative"'
    )
