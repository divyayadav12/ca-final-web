...
const Landing = ({ onStart, onNav }) => {
  return (
    ...
    >
      {/* Navbar */}
      <nav className="flex justify-between items-center px-6 md:px-12 py-4 z-10 relative">
        <FastLogo />
      ...
      <div className="flex-1 flex flex-col items-center justify-center relative z-10 px-4 pb-24 text-center mt-8 md:mt-12">
        ...
        {/* Top Right Red Text */}
        <div className="absolute top-0 right-10 md:right-32 text-[#e51c24] font-handwriting text-3xl md:text-4xl rotate-[-5deg] leading-tight hidden md:block drop-shadow-md text-right">
        ...
        {/* Left Hoodie Text */}
        <div className="absolute bottom-20 left-10 md:left-24 text-gray-300 font-handwriting text-3xl md:text-4xl rotate-[-8deg] leading-tight hidden lg:block opacity-80 drop-shadow-lg text-left">
